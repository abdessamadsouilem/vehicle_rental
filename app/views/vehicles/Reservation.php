...
<div class="container">
  ...
  <tbody>
    <tr>
      ...
      <td  ><a  href="<?php echo URLROOT; ?>/vehicles/update_Reservation?id=<?php echo $Res->id ?>" type="button" class="btn btn-primary"><i class="fas fa-edit"></i></a></td>
      <td  ><a href="<?php echo URLROOT; ?>/vehicles/delete_Reservation?id=<?php echo $Res->id ?>" onclick="" type="button" class="btn btn-danger"><i class="fas fa-trash"></i></a></td>
    </tr>
