        ...
        <div class="col-sm-auto bg-light sticky-top">
            <div class="d-flex flex-sm-column flex-row flex-nowrap bg-light align-items-center sticky-top">
                ...
                <ul class="nav nav-pills nav-flush flex-sm-column flex-row flex-nowrap mb-auto mx-auto text-center align-items-center">
                    ...
                    <li>
                        <a href="<?php echo URLROOT; ?> /dashboardUsers/dashboardUser" class="nav-link py-3 px-2" title="dashboard" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Dashboard">
                        <i class="fas fa-tachometer-alt"></i>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo URLROOT; ?>/dashboardUsers/Reservation" class="nav-link py-3 px-2" title="Reservation" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Orders">
...
<br>
<h3>here you can do what you want , add new Reservation, update Reservation, or delete Reservation.</h3>
<br>
<br>
</div>
<div id="show_vehicle">
